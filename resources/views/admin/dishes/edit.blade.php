...
<section>
    ...
    <h1 class="text-center text-info mb-4">Modifica piatto</h1>
    ...
    <form action="{{ route('admin.dishes.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-8 my-3">
            ...
            <div class="custom-control custom-radio">
                ...
                value="{{$category->id}}"
                name="category_id"
                {{ $dish->category_id, old('category_id') ? 'checked' : '' }}
                required>
        ...
        <div class="form-group col-md-8 my-3">
            <div class="custom-control custom-radio">
                <input type="radio" id="true" name="visible" value="1" {{ $dish->visible, old('visible') ? 'checked' : '' }} class="custom-control-input">
                <label class="custom-control-label" for="true">Piatto visibile</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" id="false" name="visible" value="0" {{ $dish->visible, old('visible') ? 'checked' : '' }}  class="custom-control-input">
