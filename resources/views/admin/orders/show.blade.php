      ...
      <div class="card my-5">
          ...
          <div class="card-body">
              ...
              <ul class="list-group list-group-flush my-4">
                  ...
                  <ul class="list-group list-group-flush my-4">
                        <li class="list-group-item d-inline-block"><img src="{{ asset('storage/' . Arr::get($dish, 'img')) }}" alt="{{ Arr::get($dish, 'name') }}"><p class="text-uppercase font-weight-bold d-inline-block ml-5">{{ $dish['name'] }}</p> x {{ $dish['pivot']['quantity'] }}</li>
              ...
              <div class="text-center">
                  ...
                  <a href="{{ route("admin.orders.index") }}" class="text-uppercase btn my_btn btn-info text-white font-weight-bold mr-3">Lista ordini</a>
